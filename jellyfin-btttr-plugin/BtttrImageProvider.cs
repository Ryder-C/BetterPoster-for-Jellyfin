...
namespace Jellyfin.Plugin.BtttrPosters
{
    public class BtttrImageProvider : IRemoteImageProvider, IHasOrder
    {
        ...
        public Task<IEnumerable<RemoteImageInfo>> GetImages(BaseItem item, CancellationToken cancellationToken)
        {
            ...
            // It supports the placeholder {imdb_id}, which is replaced at request time.
            ...
            {
                urlTemplate = "https://btttr.cc/poster-n/imdb/poster-default/{imdb_id}.jpg?tag=none";
            }

            // Generate Btttr.cc URL by substituting the IMDb ID.
